...
if __name__ == "__main__":
    query_search = input('Enter start of set code or whole set code:').strip().upper()
    main_filters = {
        '0': (Card.condition == 'Near Mint', Card.set_code.startswith(query_search)),
        'none': (Card.condition == "Near Mint", Card.EBAYCOM_USD_PRICE.is_(None)),
