...
class CompanyDataController(BaseController):
    ...
    def migrate(self, url, db_controller):
        # self.local_path = 'F:\\task\\webscrapping\\UKGovernment\\data\\BasicCompanyDataAsOneFile-2020-05-01.zip'
        # self.unzipped_path = 'F:\\task\\webscrapping\\UKGovernment\\data\\BasicCompanyDataAsOneFile-2020-05-01'
