...
class CaptionController():
    ...
    def twitterLogin(self):
        try:
            ...
            username_input = self.browser.find_element_by_xpath('//input[@name="session[username_or_email]"]')
            password_input = self.browser.find_element_by_xpath('//input[@name="session[password]"]')
            ...
            login_button = self.browser.find_element_by_xpath('//div[@data-testid="LoginForm_Login_Button"]')
            login_button.click()
